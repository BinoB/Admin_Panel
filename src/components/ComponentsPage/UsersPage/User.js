                            ...
                            <div className="row mt-4">
                              <div className="col-md-12">
                                <button
                                  ...
                                  onClick={
                                    selectedUserId !== null ? editUser : addUser
                                  }
                                >
                                  {selectedUserId !== null
                                    ? "Save"
                        ...
                        <div className="card">
                          ...
                          <div className="card-body">
                                    ...
                                    .map((user) => (
                                      <tr key={user.id}>
                                        ...
                                        <td>
                                          <button
                                            type="button"
                                            className="btn btn-sm btn-primary rounded-pill me-2 mr-2"
                                            onClick={() =>
                                              selectUserForEdit(user.id)
                                            }
                                          >
                                            Edit
                                          </button>
                            ...
                            <ReactPaginate
                              ...
                              containerClassName={
                                "pagination mt-4 justify-content-center"
                              }
